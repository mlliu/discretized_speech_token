from transformers import AutoProcessor, Wav2Vec2Model, Wav2Vec2ForPreTraining
import torch
...
last_hidden_states = outputs.hidden_states[-1] # the real-value representation of the input audio
projected_quantized_states = outputs.projected_quantized_states # the quantized representation of the input audio
...
print(projected_quantized_states.shape) # torch.Size([73, 292, 256])
